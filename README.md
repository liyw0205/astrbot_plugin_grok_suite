...
| 解图 | `/grok解图 [指定风格]` | 基于固定提示词生成概念分解图片 |
| 手办化 | `/grok手办化 [指定风格]` | 基于固定提示词生成手办化图片 |
| 氛围感 | `/grok氛围感 [指定风格]` | 基于固定提示词生成氛围感图片 |
| 氛围感 | `/grok变COS [指定风格]` | 基于固定提示词生成COS图片 |
| 氛围感 | `/grok变真人 [指定风格]` | 基于固定提示词生成真人图片 |
